<template>
  <v-dialog v-model="modalVisible" width="750px" scrollable v-if="campaign && proposal">
    <v-card class="grey lighten-3">
      <v-card-title class="title white--text purple">
        <v-layout row wrap>
          ...
          <v-flex xs15 pl-4>
            <!-- TODO set h5 -->
            <div class="subheading pa-1 mb-0"><strong>Chat with {{ campaign.advertiser.name }}</strong></div>

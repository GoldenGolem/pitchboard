<template>
  <div class="main-content">
    ...
    <v-list two-line dense>
          ...
          <v-layout row align-center>
            ...
            <v-flex sm8 class="ml-2 caption" @click="openProposal(conversation)">
              ...
              <v-list-tile-sub-title class="caption">
                {{ conversation.conversation.proposal.fee_gross | currency }}
      ...
      <v-list-tile v-if="loading" style="height: 150px">
  ...
  export default {
    ...
    methods: {
      ...
      openProposal(conversation) {
        ...
        this.$http.get(`proposal/${conversation.conversation.proposal_id}`).then(result => {
